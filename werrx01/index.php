...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    <p>Your PC has alerted us that it has been infected with a Adware App. The following data has been
        compromised.</p>
    ...
    <div class="action_buttons"><a class="active" id="leave_page"
                                   style="cursor: pointer; color: #FFFFFF !important;">Run Safe</a> <a class="active"
                                                                                                 id="leave_page"
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".pro_box2").delay(1300).fadeIn(800);
        $(".pro_box3").delay(2300).fadeIn(800);
        $(".pro_box3").delay(3300).fadeIn(800);
        $("#pop_up_new").delay(3300).fadeIn(800);
        $("#poptxt").delay(4300).fadeIn(800);
